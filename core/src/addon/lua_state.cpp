...
namespace
{
    ...
    constexpr std::size_t size(char const (&)[N]) { return N - 1; }
...
extern "C"
{
    static int panic_handler(::lua_State*) noexcept(false) { windower::fail_fast(); }
    ...
    static int luaopen_math_wrapped(::lua_State* s) { return wrap(s, ::luaopen_math); }
    static int luaopen_string_wrapped(::lua_State* s) { return wrap(s, ::luaopen_string); }
    static int luaopen_table_wrapped(::lua_State* s) { return wrap(s, ::luaopen_table); }
    static int luaopen_io_wrapped(::lua_State* s) { return wrap(s, ::luaopen_io); }
    static int luaopen_os_wrapped(::lua_State* s) { return wrap(s, ::luaopen_os); }
    static int luaopen_package_wrapped(::lua_State* s) { return wrap(s, ::luaopen_package); }
    static int luaopen_debug_wrapped(::lua_State* s) { return wrap(s, ::luaopen_debug); }
    static int luaopen_bit_wrapped(::lua_State* s) { return wrap(s, ::luaopen_bit); }
    static int luaopen_jit_wrapped(::lua_State* s) { return wrap(s, ::luaopen_jit); }

    static void push_lib_values(::lua_State* s, windower::lua::lib lib, bool wrapped)
    {
        switch (lib)
        {
        case windower::lua::lib::math:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_math_wrapped : ::luaopen_math, 0);
            ::lua_pushlstring(s, LUA_MATHLIBNAME, size(LUA_MATHLIBNAME));
            break;
        case windower::lua::lib::string:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_string_wrapped : ::luaopen_string, 0);
            ::lua_pushlstring(s, LUA_STRLIBNAME, size(LUA_STRLIBNAME));
            break;
        case windower::lua::lib::table:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_table_wrapped : ::luaopen_table, 0);
            ::lua_pushlstring(s, LUA_TABLIBNAME, size(LUA_TABLIBNAME));
            break;
        case windower::lua::lib::io:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_io_wrapped : ::luaopen_io, 0);
            ::lua_pushlstring(s, LUA_IOLIBNAME, size(LUA_IOLIBNAME));
            break;
        case windower::lua::lib::os:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_os_wrapped : ::luaopen_os, 0);
            ::lua_pushlstring(s, LUA_OSLIBNAME, size(LUA_OSLIBNAME));
            break;
        case windower::lua::lib::package:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_package_wrapped : ::luaopen_package, 0);
            ::lua_pushlstring(s, LUA_LOADLIBNAME, size(LUA_LOADLIBNAME));
            break;
        case windower::lua::lib::debug:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_debug_wrapped : ::luaopen_debug, 0);
            ::lua_pushlstring(s, LUA_DBLIBNAME, size(LUA_DBLIBNAME));
            break;
        case windower::lua::lib::bit:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_bit_wrapped : ::luaopen_bit, 0);
            ::lua_pushlstring(s, LUA_BITLIBNAME, size(LUA_BITLIBNAME));
            break;
        case windower::lua::lib::jit:
            ::lua_pushcclosure(s, wrapped ? ::luaopen_jit_wrapped : ::luaopen_jit, 0);
            ::lua_pushlstring(s, LUA_JITLIBNAME, size(LUA_JITLIBNAME));
            break;
        case windower::lua::lib::ffi:
            ::lua_pushcclosure(s, ::luaopen_ffi, 0);
    ...
    {
        auto const lib = *static_cast<windower::lua::lib*>(::lua_touserdata(s, 1));
    ...
    static int preload_lib(::lua_State* s) noexcept(false)
    {
        ...
        {
            ::lua_pushlstring(s, "\"package\" lib must be loaded to use preload.", 44);
            ::lua_error(s);
        }
...
windower::lua::interpreter& windower::lua::interpreter::operator=(interpreter&& other) noexcept
{
    if (auto ptr = unsafe::unwrap(m_state))
        ::lua_close(ptr);
    unsafe::unwrap(m_state) = unsafe::unwrap(other.m_state);
...
windower::lua::interpreter::operator windower::lua::state() const noexcept { return m_state; }
