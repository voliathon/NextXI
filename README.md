...
It does have a working dgVoodoo2 Game Engine that target DX11 instead of DX8/DX9. If you want to play the game in Vanilla mode you code with NextXI but there will be no supported Addons.
